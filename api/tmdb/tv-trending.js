 ...
 * Proxies TMDB /trending/tv/{time_window} endpoint
 */
...
export default async function handler(req, res) {
  ...
  try {
    const url = new URL(`${TMDB_BASE_URL}/trending/tv/${timeWindow}`);
    ...
    console.error('Error proxying TV trending request:', error);
