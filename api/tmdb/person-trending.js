 ...
 * Proxies TMDB /trending/person/{time_window} endpoint
 */
...
export default async function handler(req, res) {
  ...
  try {
    const url = new URL(`${TMDB_BASE_URL}/trending/person/${timeWindow}`);
    ...
    console.error('Error proxying trending people request:', error);
